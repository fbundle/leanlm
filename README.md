...
- if scaling up, we could certainly optimize over a trajectory rather than a single answer, just like giving the LLM a lean compiler, and it talks to the compiler for a while until it is able to figure out a solution. but search space would explore, I wonder how people train large LLM in real world
